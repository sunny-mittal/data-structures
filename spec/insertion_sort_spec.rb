...
describe 'Insertion sort method' do
  ...
  it 'is benchmarked for awesomeness' do
    puts 'Best'
    puts Benchmark.measure { (1..10000).to_a.insertion_sort }
    puts 'Worst'
    puts Benchmark.measure { 10000.downto(1).to_a.insertion_sort }
    puts 'Random'
    puts Benchmark.measure { (1..10000).to_a.shuffle.insertion_sort }
  end
end
